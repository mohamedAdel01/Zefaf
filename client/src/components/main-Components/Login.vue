<template>
  <div>
    ...
    <div class="jumbotron form-group">
      <h1 class="mx-auto mt-5" style="width: 450px">Login page content</h1>
      <form class="mx-auto mt-5" style="width: 450px" @submit.prevent="login">
        ...
        <p v-if="this.error" class="text-light bg-danger text-center mt-1">please fill all the require fields</p>
