  ...
  <div style="height:1000px">
    ...
    <form @submit="sendReq()">
      ...
      <section id="service-info">
        ...
        <div>
          <h5>Dress:</h5>
          <input type="checkbox" v-model="visibility.Dress">
          <label for="checkbox">available: {{ visibility.Dress }}</label><br/>

          <div v-if="visibility.Dress" class="service-options" id="Dress">
            <span>image for Dress: </span><input type="file" @change="showServiceIMG($event, 'Dress')"/><br/>
            ...
            <div id="2inp">
              <span>details for Dress: </span><textarea class="form-control" placeholder="details for Dress"></textarea><br/>
              ...
              <button class="btn btn-success" @click.prevent="addItem('Dress')">add</button>
              <button class="btn btn-danger" @click.prevent="undoItem('Dress')">undo</button>
            </div>
          </div><hr/>
        </div>
      </section>
    ...
    <div id="showData">
      ...
      <div class="collection">
        <h5>Dress</h5>
        <div class="">{{req.services.Dress}}</div>
        <img :src="img" v-for="(img, index) in showImgs.Dress" :key="index"/>
