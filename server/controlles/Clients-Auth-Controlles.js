...
const saltRounds = 10
const ClientsUser = require('../models/Clients-User')

module.exports = {
    async ClientsAddUser(req, res) {
        bcrypt.hash(req.body.password, saltRounds, (err, hash) => {
            ...
            ClientsUser.create(req.body).then((user) => {
    ...
    async ClientsLogin(req, res) {
        var user = await ClientsUser.findOne({email: req.body.email})
